...
Reusable button primitive with CVA variants and size presets.
...
Dialog shell used by onboarding and other modal flows.
...
Popover primitive used by model pickers and compact overlays.
...
Ambient studio animation used in the onboarding split layout. Keep this visual as an atmospheric companion rather than a content surface.
