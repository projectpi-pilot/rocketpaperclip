...
export function OpenClawGatewayConfigFields({
  ...
  return (
    <>
      ...
      {!isCreate && (
        <>
          <Field label="MSX API URL override">
            <DraftInput
              value={
                eff(
                  "adapterConfig",
          ...
          <Field label="Device auth">
            <div className="text-xs text-muted-foreground leading-relaxed">
              Always enabled for gateway agents. MSX persists a device key during onboarding so pairing approvals
